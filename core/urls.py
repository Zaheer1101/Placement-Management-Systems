...
urlpatterns = [
    path('company/shortlisted-candidates/<int:job_id>/', views.shortlisted_candidates_view, name='shortlisted_candidates'),
    ...
    path('company/ajax/update_application_status/', views.update_application_status, name='update_application_status'),
...
# ==============================================================================
    ...
    path('tpo/jobs/edit-status/<int:job_id>/', views.edit_job_status_view, name='edit_job_status'),
    ...
    path('tpo/reports/export-summary-pdf/', views.export_summary_pdf_view, name='export_summary_pdf'),
    path('tpo/upload/', views.bulk_upload_view, name='bulk_upload'),
    path('tpo/logs/', views.audit_logs_view, name='audit_logs'),
    path('tpo/jobs/approve/', views.approve_jobs_view, name='approve_jobs'),
    path('tpo/jobs/approve/<int:job_id>/', views.approve_single_job_view, name='approve_single_job'),
    path('tpo/jobs/reject/<int:job_id>/', views.reject_single_job_view, name='reject_single_job'),
    # Edit/Delete Student URLs for Admin
    path('tpo/students/edit/<int:user_id>/', views.edit_student_view, name='edit_student'),
    path('tpo/students/delete/<int:user_id>/', views.delete_student_view, name='delete_student'),
    path('tpo/students/add/', views.admin_add_student_view, name='admin_add_student'),
    path('tpo/companies/add/', views.admin_add_company_view, name='admin_add_company'),
    ...
    # Company Edit/Delete URLs for Admin
    path('tpo/companies/edit/<int:user_id>/', views.edit_company_view, name='edit_company'),
    path('tpo/companies/delete/<int:user_id>/', views.delete_company_view, name='delete_company'),
]